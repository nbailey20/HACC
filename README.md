...
Note: Username Alice was selected by providing the value A, which acts as a filtering prefix, eliminating the need to type the whole value "Alice"

Note: If multiple values match a provided prefix, further interactive input is needed to make a decision
